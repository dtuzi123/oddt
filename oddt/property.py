...
XLOGP_SMARTS_1 = OrderedDict([
    ...
    ('[#7!a,#8]-,:[cH0]=,:[a#7,a#8]', [0.366]),  # C.ar.(X).x
    ...
    ('*~[NX3H0R,NX4H0+R]', [0.881]),  # N.3.ring
    ('[#7,#8]~[NX3H0,NX4H0+]', [-0.239]),  # N.3.x
    ('[#7,#8]~[NX3H0R,NX4H0+R]', [-0.010]),  # N.3.x.ring


    # amide nitrogen
    # ('[CX3,S]([NX3H2])(=[O,S])', [-0.646]),  # 54
    # ('[!#7;!#8;!#1][NH1]C(=[O,S])', [-0.096]),  # 55
    # ('[#7,#8][NH]C(=O)[#6,#7]', [-0.044]),  # 56
    # ('[!#7;!#8;!#1]N([!#7;!#8;!#1])C(=O)', [0.078]),  # 57
    # ('[#7,#8]N([!#7;!#8;!#1])[CX3](=[OX1])', [-0.118]),  # 58

    ('[CX3,S]([NX3])(=[O,S])', [0.078]),  # N.am.unknown
    ('[CX3,S]([NX3H2])(=[O,S])', [-0.646]),  # N.am.h2
    ('[CX3,S]([NX3H1])(=[O,S])', [-0.096]),  # N.am.h
    ('[CX3,S]([NX3H1]~[#7,#8])(=[O,S])', [-0.044]),  # N.am.h.x
    ('[CX3,S]([NX3H0])(=[O,S])', [0.078]),  # N.am
    ('[CX3,S]([NX3H0]~[#7,#8])(=[O,S])', [-0.118]),  # N.am.x
