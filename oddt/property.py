...
XLOGP_SMARTS_1 = OrderedDict([
    ...
    # sp2 carbon
    ('[*]=[CH2]', [0.420]),  # 21
    ('[*]=[CH1][!#7;!#8;!#1]', [0.466,  0.136]),  # 22-23
    ('[*]=[CH1][#7,#8]', [0.001, -0.310]),  # 24-25
    ('[*]=[CH0]([!#7;!#8;!#1])[!#7;!#8;!#1]', [0.050,  0.013]),  # 26-27
    ('[*]=[CH0]([!#7;!#8;!#1])[#7,#8]', [-0.030, -0.027]),  # 28-29
    ...
    ('[*]!@[NH]!@[#7,#8]', [0.324]),  # 47
    ('[*]@[NH]@[#7,#8]', [0.153]),  # 48
    ('[!#7;!#8;!#1][NX3H0R0]([!#7;!#8;!#1])[!#7;!#8;!#1]', [0.159,  0.761]),  # 49-50 ## not in ring
    ...
    ('[#7,#8]-[OH1]', [-0.522]),  # 71
    ('[!#7;!#8;!#1][OX2][!#7;!#8;!#1]', [0.084, 0.435]),  # 72-73
    ('[!#7;!#8;!#1][OX2][#7,#8]', [0.105]),  # 74
